# pydantic makes the data tranferrable to fastapi
# uvicorn channelizes the wrapped data to fastAPI
# and corsmiddleware finally transfers the data with respect to the given language on webbrowser

from fastapi import FastAPI
import pandas as pd
import numpy as np
# if frontend and backend are in different language , so for communication corsmiddleware is used
...
@app.get("/")
def index():
    return {"message":"an API to randomly generate a chemical formula of a valid drug molecule"}
